...
candice = User.create(first_name:"Candice", last_name:"Swanepoel", email:"candice@vsangel.com", username:"candice", password:"test")

alessandra = User.create(first_name:"Alessandra", last_name:"Ambrosio", email:"alessandra@vsangel.com", username:"alessandra", password:"test")

karlie = User.create(first_name:"Karlie", last_name:"Kloss", email:"karlie@vsangel.com", username:"karlie", password:"test")
