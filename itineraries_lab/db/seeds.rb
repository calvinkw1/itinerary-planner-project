...
trip1 = Itinerary.create(name: "trip1", origin: "San Francisco", destination: "Clubs", start_date: "2015-03-15", end_date: "2015-03-25")
...
trip2 = Itinerary.create(name: "trip2", origin: "San Mateo", destination:"Hotel", start_date: "2015-12-22", end_date: "2016-01-05" )

  tetbury = Destination.create(name: "Calcot Manor", location: "Tetbury, Gloucestershire", start_date: "2015-12-22", end_date: "2015-01-04")


trip3 = Itinerary.create(name: "trip3", origin: "San Clemente", destination: "Beach", start_date: "2015-05-10", end_date: "2015-06-23")
